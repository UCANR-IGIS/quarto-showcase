...
subtitle: "Part 2: HTML Outputs"
pagetitle: "Part 2: HTML Outputs"
format: 
  revealjs:
    theme: simple
    df-print: paged
...
## Interactive Plots {.scrollable .mdfav}
...
## Paged Tables {.scrollable .ymlfav}
...
## Table-of-Contents, Code-Links, Code-Tools, Single File {.ymlfav}
...
## Quarto Reports {.exfav}

Have a lot of data? Create data-driven reports programmatically!

::: {.callout-tip title="Workflow for a Single-Page Report" collapse="true"}
...
::: {.callout-tip title="More Presentation Tips"}
See: <https://quarto.org/docs/presentations/revealjs/presenting.html>
:::
