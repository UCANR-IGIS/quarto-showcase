...
**Presenting Code in Quarto**
<p>You can print actual code chunks easily in your presentation to show how figures or plots are made.</p>
...
ggsave("transparent_plot.png", plot = p, bg = "transparent", width = 8, height = 5)
