---
title: ""
pagetitle: "Part 1: Intro to Quarto"
format:
  revealjs:
    title-slide: false
    theme: solarized
...
<section data-transition="fade">
<h1>Quarto Showcase</h1>
<span style="font-size:36px;color: #005fae;">12-11-2025</em></span>
<div style="text-align:center;">
...
<section>
<p><strong>Include your code!</strong></p>
...
<section>
<p><strong>... And show the output.</strong></p>
...
<section data-transition="slide">
  ...
  <ul>
    ...
    <li>Open source</li>
    <li>Reproducible content (generate and RE-generate lots of reports)</li>
    <li>Multi-lingual (R, Python, Julia)</li>
...
<p class="fragment" fade-up>Quarto will have **more of a learning curve,** but is still useful!</p><br>
</section>

<section data-transition="convex">
  <p> Overall, it has lots of fun bells and whistles for those who take the time to explore it!</p>
